...
#define BLYNK_TEMPLATE_ID "TMPL63_i0h8F3"
#define BLYNK_TEMPLATE_NAME "GIAM SAT NONG DO BUI MIN"
char BLYNK_AUTH_TOKEN[35] = "c7urhk4f2MLotiCs_Tu7_KpdN-1fdXz5";
...
GP2YDustSensor dustSensor(GP2YDustSensorType::GP2Y1010AU0F, DUST_TRIG, DUST_ANALOG, 60);
...
//thời gian cảnh báo bằng còi (đơn vị giây)
...
void TaskDustSensor(void *pvParameters) {
    while(1) {
      dustValue = dustSensor.getDustDensity();
